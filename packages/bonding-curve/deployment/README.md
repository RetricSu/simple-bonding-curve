...
offckb deploy --network devnet --target <contract-binary-path> --output /Users/retric/Desktop/simple-bonding-curve/packages/bonding-curve/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /Users/retric/Desktop/simple-bonding-curve/packages/bonding-curve/deployment
```
